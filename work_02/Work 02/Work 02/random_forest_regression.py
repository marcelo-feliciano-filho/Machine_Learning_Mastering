...
regressor1 = RandomForestRegressor(n_estimators = 1, random_state = 0).fit(X_train, y_train)
...
################################# Setup 2 ####################################
regressor2 = RandomForestRegressor(n_estimators = 15, random_state = 0).fit(X_train, y_train)
...
################################# Setup 3 ####################################
regressor3 = RandomForestRegressor(n_estimators = 50, random_state = 0).fit(X_train, y_train)
