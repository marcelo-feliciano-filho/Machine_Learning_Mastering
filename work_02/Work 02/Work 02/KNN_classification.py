...
################################# Setup 2 ####################################
classifier2 = KNeighborsClassifier(n_neighbors = 4, metric = 'minkowski', p = 2).fit(X_train, y_train)
...
################################# Setup 3 ####################################
classifier3 = KNeighborsClassifier(n_neighbors = 8, metric = 'minkowski', p = 2).fit(X_train, y_train)
