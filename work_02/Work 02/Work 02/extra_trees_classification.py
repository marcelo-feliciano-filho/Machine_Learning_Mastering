...
# Training the Extra Tree Classification model on the Training set
...
################################# Setup 1 ####################################
classifier1 = ExtraTreesClassifier(n_estimators=1, random_state=0).fit(X_train, y_train)
...
################################# Setup 2 ####################################
classifier2 = ExtraTreesClassifier(n_estimators=10, random_state=0).fit(X_train, y_train)
...
################################# Setup 3 ####################################
classifier3 = ExtraTreesClassifier(n_estimators=50, random_state=0).fit(X_train, y_train)
