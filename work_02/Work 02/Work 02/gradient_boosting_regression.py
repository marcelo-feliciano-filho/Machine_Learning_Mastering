...
regressor1 = GradientBoostingRegressor(n_estimators=2, random_state=0).fit(X_train, y_train)
...
################################# Setup 2 ####################################
regressor2 = GradientBoostingRegressor(n_estimators=50,random_state=0).fit(X_train, y_train)
...
################################# Setup 3 ####################################
regressor3 = GradientBoostingRegressor(n_estimators=100, random_state=0).fit(X_train, y_train)
