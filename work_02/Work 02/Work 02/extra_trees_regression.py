...
regressor1 = ExtraTreesRegressor(n_estimators=1, random_state=0).fit(X_train, y_train)
...
################################# Setup 2 ####################################
regressor2 = ExtraTreesRegressor(n_estimators=10, random_state=0).fit(X_train, y_train)
...
################################# Setup 3 ####################################
regressor3 = ExtraTreesRegressor(n_estimators=50, random_state=0).fit(X_train, y_train)
