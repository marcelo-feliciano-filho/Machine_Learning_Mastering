...
from sklearn.metrics import (confusion_matrix, f1_score, average_precision_score, plot_precision_recall_curve,
                            precision_recall_curve)

################################# Setup 1 ####################################
classifier1 = DecisionTreeClassifier(max_depth=1, criterion = 'entropy', random_state = 0).fit(X_train, y_train)
...
################################# Setup 2 ####################################
classifier2 = DecisionTreeClassifier(max_depth=3, criterion = 'entropy', random_state = 0).fit(X_train, y_train)
...
################################# Setup 3 ####################################
classifier3 = DecisionTreeClassifier(max_depth=8, criterion = 'entropy', random_state = 0).fit(X_train, y_train)
