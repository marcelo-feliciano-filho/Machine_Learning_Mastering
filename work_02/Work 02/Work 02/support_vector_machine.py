...
################################# Setup 1 ####################################
classifier1 = SVC(kernel = 'poly',degree = 1, random_state = 0).fit(X_train, y_train)
...
################################# Setup 2 ####################################
classifier2 = SVC(kernel = 'rbf', random_state = 0).fit(X_train, y_train)
...
################################# Setup 3 ####################################
classifier3 = SVC(kernel = 'linear', random_state = 0).fit(X_train, y_train)
