...
################################# Setup 1 ####################################
regressor1 = DecisionTreeRegressor(max_depth=1, random_state = 0).fit(X_train, y_train)
...
################################# Setup 2 ####################################
regressor2 = DecisionTreeRegressor(max_depth=3, random_state = 0).fit(X_train, y_train)
...
################################# Setup 3 ####################################
regressor3 = DecisionTreeRegressor(max_depth=8, random_state = 0).fit(X_train, y_train)
